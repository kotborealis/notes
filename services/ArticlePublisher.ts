...
const defaultRender = ArticlePublisher.md.renderer.rules.link_open || function(tokens, idx, options, env, self) {
  return self.renderToken(tokens, idx, options);
};

ArticlePublisher.md.renderer.rules.link_open = function (tokens, idx, options, env, self) {
